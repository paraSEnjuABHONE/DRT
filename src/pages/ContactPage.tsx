      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            We're here to help with your geographic data needs and emergency response support
          </p>
        </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>+95 1 234 5678</p>
                    <p>+95 9 876 54321 (Emergency Hotline)</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>info@geomyanmar.org</p>
                    <p>emergency@geomyanmar.org (For Emergency Reports)</p>
                  </div>
                </div>
              </div>

              <div className="mt-10">
                <h4 className="text-lg leading-6 font-medium text-gray-900 mb-4">Office Hours</h4>
                <div className="space-y-2 text-gray-500">
                  <p>Monday - Friday: 9:00 AM - 5:00 PM</p>
                  <p>Saturday: 9:00 AM - 12:00 PM</p>
                  <p>Sunday: Closed</p>
                  <p className="text-blue-600 font-medium mt-2">* Emergency hotline available 24/7</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-10">
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Find Us</h3>
